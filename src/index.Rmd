...
locaties_prioritair %>%
  ...
  select(Locatie = locatie, "Oppervlakte leefgebied (ha)" = area_leefgebied_nieuw_ha, "Oppervlakte grote zeggenvegetatie (ha)" = area_rbbmc_ha, "Aantal zoekpunten" = n_punten) %>%
